"""LLM-as-judge. Different model family than the generator when Groq is configured.

Validate by re-labelling 40–60 verdicts by hand and reporting agreement / Cohen's κ.
Do not put this judge on the runtime send path.
"""
...
RUBRIC = """Score 1-5 independently:
- groundedness: reply uses only retrieved/historical evidence, no invented policy
- helpfulness: would a customer know the next step
- tone: professional, not sarcastic or over-apologetic without content
- escalation_correctness: 5 if escalate/auto matches the gold decision, else 1-2
